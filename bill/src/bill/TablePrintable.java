...
class TablePrintable implements Printable {
    ...
    public TablePrintable(JTable table, JTable.PrintMode printMode, MessageFormat headerFormat,
        ...
        headerFont = table.getFont().deriveFont(Font.PLAIN, HEADER_FONT_SIZE);
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        if (footerText != null) {
            ...
            fRect = new Rectangle2D.Double(fRect.getX(), Math.abs(fRect.getY()), fRect.getWidth(),
                    fRect.getHeight()*nbLines);
        ...
        if (footerText != null) {
            ...
            g2d.translate(0, imgHeight - footerTextSpace- 30);
